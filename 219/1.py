...
v = np.loadtxt("LW219-1.txt")       # открыть файл с данными
...
plt.title ("Статическая вольт-амперная характеристика диода")	    # название графика
...
plt.scatter(x, y, s=7, c='red', marker="o", alpha = 1)     # отображение точек
