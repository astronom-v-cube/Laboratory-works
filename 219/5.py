...
v = np.loadtxt("LW219-5.txt")       # открыть файл с данными
...
plt.title ("Зависимость динамического коэффициента усиления от сопротивления")	    # название графика
plt.xlabel("Rα, кОм", fontsize=10, color='blue')		# ось абсцисс (x)
