...
x2 = [item[8] for item in v]			# первый столбец - y
x1 = [item[9] for item in v]			# первый столбец - y
y1 = [item[0] for item in v]			# второй стобец - x
y2 = [item[1] for item in v]			# второй стобец - x
y3 = [item[2] for item in v]			# второй стобец - x
y4 = [item[3] for item in v]			# второй стобец - x
y5 = [item[4] for item in v]			# второй стобец - x
y6 = [item[5] for item in v]			# второй стобец - x
y7 = [item[6] for item in v]			# второй стобец - x
y8 = [item[7] for item in v]			# второй стобец - x
...
p7 = np.polyfit(x2, y7, 1)				# создание полинома первой степени - апроксимация
p8 = np.polyfit(x1, y8, 1)				# создание полинома первой степени - апроксимация
...
yg = np.polyval(p7, x2)				# координаты y для полинома
yh = np.polyval(p8, x1)				# координаты y для полинома
...
plt.ylabel("U (mV)", fontsize=10, color='red') 		# ось ординат (y)
...
# plt.plot(x1, ya, label='U при В = 0 и J +')        # график - апрокимация (прямая)
# plt.plot(x2, yb, label='U при В = 0 и J -')        # график - апрокимация (прямая)
...
plt.plot(x2, yg, label='U при В = +2400 и J +')        # график - апрокимация (прямая)
plt.plot(x1, yh, label='U при В = +2400 и J -')        # график - апрокимация (прямая)


plt.scatter(x2, y1, s=12, c='red', marker="o", alpha = 1)     # отображение точек
plt.scatter(x1, y2, s=12, c='red', marker="^", alpha = 1)     # отображение точек
plt.scatter(x1, y3, s=12, c='red', marker="s", alpha = 1)     # отображение точек
plt.scatter(x2, y4, s=12, c='red', marker="+", alpha = 1)     # отображение точек
plt.scatter(x1, y5, s=12, c='red', marker="D", alpha = 1)     # отображение точек
plt.scatter(x2, y6, s=12, c='red', marker="*", alpha = 1)     # отображение точек
plt.scatter(x2, y7, s=12, c='red', marker="p", alpha = 1)     # отображение точек
plt.scatter(x1, y8, s=12, c='red', marker="x", alpha = 1)     # отображение точек
