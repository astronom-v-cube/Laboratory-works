...
v = np.loadtxt("LW217-1.txt")       # открыть файл с данными
...
plt.title ("Исследование вынужденных колебаний в электрическом контуре, (R = 100 Ом)")	    # название графика
...
# plt.plot(nu, Ucf, c='green', label=r'Теоретический график $U_{C}$')        # стандартный график (ломаная)
...
# plt.scatter(y, x2, s=10, c='green', marker="x", alpha = 1, label=r'Практические значения $U_{C}$')     # отображение точек
